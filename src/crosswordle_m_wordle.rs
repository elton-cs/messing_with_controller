#[derive()]
pub struct CrosswordleMWordle<A: starknet::accounts::ConnectedAccount + Sync> {
    pub address: starknet::core::types::Felt,
    pub account: A,
    pub block_id: starknet::core::types::BlockId,
}
impl<A: starknet::accounts::ConnectedAccount + Sync> CrosswordleMWordle<A> {
...
#[derive()]
pub struct CrosswordleMWordleReader<P: starknet::providers::Provider + Sync> {
    pub address: starknet::core::types::Felt,
    pub provider: P,
    pub block_id: starknet::core::types::BlockId,
}
impl<P: starknet::providers::Provider + Sync> CrosswordleMWordleReader<P> {
...
#[derive()]
pub struct Wordle {
    pub id: starknet::core::types::Felt,
    pub l1: u8,
    pub l2: u8,
    pub l3: u8,
    pub l4: u8,
...
impl cainome::cairo_serde::CairoSerde for Wordle {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += starknet::core::types::Felt::cairo_serialized_size(&__rust.id);
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
        __out.extend(starknet::core::types::Felt::cairo_serialize(&__rust.id));
    ...
    fn cairo_deserialize(
        ...
        let mut __offset = __offset;
        let id = starknet::core::types::Felt::cairo_deserialize(__felts, __offset)?;
        __offset += starknet::core::types::Felt::cairo_serialized_size(&id);
...
impl cainome::cairo_serde::CairoSerde for WordleValue {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
...
impl<A: starknet::accounts::ConnectedAccount + Sync> CrosswordleMWordle<A> {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn ensure_abi(&self, model: &Wordle) -> cainome::cairo_serde::call::FCall<A::Provider, ()> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(Wordle::cairo_serialize(model));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
    ...
    pub fn ensure_values(
        ...
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(WordleValue::cairo_serialize(value));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
...
impl<P: starknet::providers::Provider + Sync> CrosswordleMWordleReader<P> {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn ensure_abi(&self, model: &Wordle) -> cainome::cairo_serde::call::FCall<P, ()> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(Wordle::cairo_serialize(model));
        let __call = starknet::core::types::FunctionCall {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn ensure_values(&self, value: &WordleValue) -> cainome::cairo_serde::call::FCall<P, ()> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(WordleValue::cairo_serialize(value));
        let __call = starknet::core::types::FunctionCall {
