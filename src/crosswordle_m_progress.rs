#[derive()]
pub struct CrosswordleMProgress<A: starknet::accounts::ConnectedAccount + Sync> {
    pub address: starknet::core::types::Felt,
    pub account: A,
    pub block_id: starknet::core::types::BlockId,
}
impl<A: starknet::accounts::ConnectedAccount + Sync> CrosswordleMProgress<A> {
...
#[derive()]
pub struct CrosswordleMProgressReader<P: starknet::providers::Provider + Sync> {
    pub address: starknet::core::types::Felt,
    pub provider: P,
    pub block_id: starknet::core::types::BlockId,
}
impl<P: starknet::providers::Provider + Sync> CrosswordleMProgressReader<P> {
...
pub struct Progress {
    ...
    pub possible_score: u64,
}
impl cainome::cairo_serde::CairoSerde for Progress {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size += u64::cairo_serialized_size(&__rust.level);
        __size += u64::cairo_serialized_size(&__rust.score);
        __size += u64::cairo_serialized_size(&__rust.possible_score);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
        ...
        __out.extend(u64::cairo_serialize(&__rust.level));
        __out.extend(u64::cairo_serialize(&__rust.score));
        __out.extend(u64::cairo_serialize(&__rust.possible_score));
        __out
    }
    fn cairo_deserialize(
        __felts: &[starknet::core::types::Felt],
        ...
        let level = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&level);
        let score = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&score);
        let possible_score = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&possible_score);
        Ok(Progress {
            player_id,
            level,
            score,
...
impl cainome::cairo_serde::CairoSerde for ProgressValue {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
...
impl<A: starknet::accounts::ConnectedAccount + Sync> CrosswordleMProgress<A> {
    ...
    pub fn ensure_abi(
        ...
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(Progress::cairo_serialize(model));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
    ...
    pub fn ensure_values(
        ...
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(ProgressValue::cairo_serialize(value));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
...
impl<P: starknet::providers::Provider + Sync> CrosswordleMProgressReader<P> {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn ensure_abi(&self, model: &Progress) -> cainome::cairo_serde::call::FCall<P, ()> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(Progress::cairo_serialize(model));
        let __call = starknet::core::types::FunctionCall {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn ensure_values(&self, value: &ProgressValue) -> cainome::cairo_serde::call::FCall<P, ()> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(ProgressValue::cairo_serialize(value));
        let __call = starknet::core::types::FunctionCall {
